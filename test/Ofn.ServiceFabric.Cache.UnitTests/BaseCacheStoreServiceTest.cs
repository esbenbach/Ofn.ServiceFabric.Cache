namespace Ofn.ServiceFabric.Cache.UnitTests
{
    ...
    public class BaseCacheStoreServiceTest
    {
        ...
        [Theory(Skip = "Not entirely sure this test makes sense because it relies on setting the value again and again instead of 'just' updating last accessed key"), AutoMoqData]
        ...
        class StubCacheStoreService : BaseCacheStoreService
        {
